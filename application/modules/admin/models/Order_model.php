...
class Order_model extends CI_Model
{
    ...
    // Tambahkan di bagian paling bawah sebelum penutup class
public function get_order_by_id($id)
{
    $this->db->select('o.*, c.name AS coupon_name, cu.name AS customer_name');
    $this->db->from('orders o');
    $this->db->join('coupons c', 'c.id = o.coupon_id', 'left');
    $this->db->join('customers cu', 'cu.user_id = o.user_id', 'left');
