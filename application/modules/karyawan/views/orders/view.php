    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="<?php echo site_url('karyawan/orders/pdf/' . $data->id); ?>" class="btn btn-info"><i class="fa fa-print"></i> Print</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
      ...
      <div class="card-wrapper">
        <div class="card">
          ...
          <div class="card-footer">
            <form action="<?php echo site_url('karyawan/orders/status'); ?>" method="POST">
    ...
    <div class="col-md-4">
      ...
      <div class="card card-primary" id="#payments">
        ...
        <?php if ($data->payment_price != NULL) : ?>
          <div class="card-footer">
            <form action="<?php echo site_url('karyawan/payments/verify'); ?>" method="POST">
              <div class="row">
