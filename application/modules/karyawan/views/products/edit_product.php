...
?>
            ...
            <div class="col-lg-6 col-5 text-right">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo site_url('karyawan/products/view/'. $product->id); ?>"><?php echo $product->name; ?></a></li>
    ...
    <div class="container-fluid mt--6">
      <?php echo form_open_multipart('karyawan/products/edit_product'); ?>
    ...
    <script>
        $('.deletePictureBtn').click(function(e) {
            ...
            $.ajax({
                method: 'POST',
                url: '<?php echo site_url('karyawan/products/product_api?action=delete_image'); ?>',
                data: {
