          ...
          <div class="card-wrapper">
            <div class="card">
              ...
              <div>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tr>
                        <td>Kategori</td>
                        <td>:</td>
                        <td><b><?php echo anchor('karyawan/products?category_id='. $product->category_id, $product->category_name); ?></b></td>
                    </tr>
                    <tr>
                        <td>Stok / Satuan</td>
                        <td>:</td>
              ...
              <div class="card-footer text-right">
                  <a href="<?php echo site_url('karyawan/products/edit/'. $product->id); ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
              ...
              <table class="table align-items-center table-flush">
                ...
                <?php foreach ($orders as $order) : ?>
                  <tr>
                    ...
                    <td><?php echo anchor('karyawan/orders/view/'. $order->order_id, '#'. $order->order_number); ?></td>
                    <td>
                      <?php echo $order->name; ?>
                    </td>
...
<script>
    $('#deleteProductForm').submit(function(e) {
        ...
        $.ajax({
            method: 'POST',
            url: '<?php echo site_url('karyawan/products/product_api?action=delete_product'); ?>',
            data: data,
            success: function (res) {
                if (res.code == 204) {
                    ...
                    setTimeout(function() {
                        window.location = '<?php echo site_url('karyawan/products'); ?>';
                    }, 6000);
                }
                else {
