...
<script>
  $(document).ready(function() {
    ...
    $(document).on('click', '.btnEdit', function() {
      ...
      $.ajax({
        method: 'GET',
        url: '<?php echo site_url('karyawan/products/category_api?action=view_data'); ?>',
        data: {id: id},
    ...
    $('#editCategoryForm').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('karyawan/products/category_api?action=edit_category'); ?>',
        data: data,
        success: function (res) {
          if (res.code == 201) {
    ...
    $('#deleteCategory').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('karyawan/products/category_api?action=delete_category'); ?>',
        data: {
            id: id
        },
        success: function (res) {
    ...
    var table = $('#packageList').DataTable({
      "ajax" : "<?php echo site_url('karyawan/products/category_api?action=list'); ?>",
      "columns" : [
        {"data": "id"},
        {"data": "name"},
    ...
    $('#addCategoryForm').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('karyawan/products/category_api?action=add_category'); ?>',
        data: data,
        context: this,
        success: function(res) {
          if (res.data) {
