            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('karyawan/orders'); ?>">
                                <i class="fa fa-file-invoice text-danger"></i>
                                <span class="nav-link-text">Pesanan</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('karyawan/payments'); ?>">
                                <i class="fa fa-money-bill-alt text-warning"></i>
                                <span class="nav-link-text">Pembayaran</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('karyawan/customers'); ?>">
                                <i class="fa fa-users text-primary"></i>
                                <span class="nav-link-text">Pelanggan</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('karyawan/reviews'); ?>">
                                <i class="fa fa-edit text-info"></i>
                                <span class="nav-link-text">Review Pelanggan</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('karyawan/contacts'); ?>">
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main"
                        action="<?php echo site_url('karyawanorders'); ?>" required>
                        <?php else : ?>
                        <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main"
                            action="<?php echo site_url('karyawan/products/search'); ?>" required>
                            <?php endif; ?>
                        ...
                        <ul class="navbar-nav align-items-center ml-auto ml-md-0">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="<?php echo site_url('karyawan/settings/profile'); ?>" class="dropdown-item">
                                        <i class="ni ni-single-02"></i>
                                        <span>Profil</span>
                                    </a>
                                    <a href="<?php echo site_url('karyawan/settings'); ?>" class="dropdown-item">
