                    ...
                    <ul class="list-group list-group-flush list my--3">
                        ...
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="<?php echo site_url('karyawan/customers/view/' . $customer->id); ?>"
                            ...
                            <div class="checklist-item checklist-item-info">
                                <div class="checklist-info">
                                    <h5 class="checklist-title mb-0">
                                        <?php echo anchor('karyawan/orders/view/' . $order->id, 'Order #' . $order->order_number); ?>
                                    </h5>
                    ...
                    <ul class="list-group list-group-flush list my--3">
                        ...
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <!-- Avatar -->
                                    <a href="<?php echo site_url('karyawan/payments/users/' . $payment->user_id); ?>"
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <a href="<?php echo site_url('karyawan/products'); ?>" class="btn btn-sm btn-primary">Lihat
                                semua</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <a href="<?php echo site_url('karyawan/products/category'); ?>"
