            ...
            <div class="col-lg-6 col-5 text-right">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><?php echo anchor('karyawan/customers', 'Pelanggan'); ?></li>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <?php foreach ($orders as $order) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo anchor('karyawan/orders/view/'. $order->id, '#'. $order->order_number); ?>
                                    </td>
                                    <td>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <?php foreach ($payments as $payment) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo anchor('karyawan/paymeny/view/'. $payment->id, $payment->order_number); ?>
                                    </td>
                                    <td>
...
<script>
    ...
    $('#deleteCustomer').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('karyawan/customers/api/delete'); ?>',
        data: {
            id: id
        },
        success: function (res) {
          if (res.code == 204) {
            ...
            setTimeout(() => {
                window.location = '<?php echo site_url('karyawan/customers'); ?>';
            }, 4000);
          }
        }
      })
