                ...
                <div class="col-lg-6 col-5 text-right">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            <li class="breadcrumb-item"><a href="<?php echo site_url('karyawan'); ?>"><i
                                        class="fas fa-home"></i></a></li>
                            <li class="breadcrumb-item"><a
                                    href="<?php echo site_url('karyawan/settings'); ?>">Pengaturan</a></li>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name"
                                        value="<?php echo set_value('name', get_admin_name()); ?>" class="form-control"
                                        id="name" minlength="4" maxlength="255" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email"
                                        ...
                                        id="email" minlength="10" maxlength="255" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username"
                                        ...
                                        class="form-control" id="username" minlength="4" maxlength="16" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <p class="text-muted"><small>Kosongkan password jika tidak ingin mengganti</small>
                                    </p>
